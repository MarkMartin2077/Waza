...
protocol CheckInInteractor: GlobalInteractor {
    ...
    func generateCheckInEncouragement(userName: String, streakCount: Int, classesThisWeek: Int, weeklyTarget: Int, belt: BJJBelt, totalAttendance: Int) -> AsyncThrowingStream<String, Error>
