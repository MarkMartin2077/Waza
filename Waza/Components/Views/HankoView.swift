...
#Preview("With Labels") {
    HStack(spacing: 16) {
        HankoView(kanji: "技", label: "Gi", size: 36, rotation: -2)
        HankoView(kanji: "体", label: "No-Gi", size: 36, rotation: 1)
        HankoView(kanji: "道", label: "Open", size: 36, rotation: -3, color: .wazaInk900)
        HankoView(kanji: "練", label: "Drill", size: 36, rotation: 2)
        HankoView(kanji: "試", label: "Comp", size: 36, rotation: -1)
        HankoView(kanji: "師", label: "Pvt", size: 36, rotation: 3, color: .wazaInk900)
    }
    .padding()
}
